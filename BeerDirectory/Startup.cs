...
namespace BeerDirectory
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			// connection
			services.AddSingleton<BeerDirectoryMongoClient, BeerDirectoryMongoClient>(_ =>
				new BeerDirectoryMongoClient(Configuration["Data:MongoClient:ConnectionString"],
					Configuration["Data:MongoClient:DbName"]));
